            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground">
                        Our Cart is <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-500">Getting Juicier!</span>
                    </h1>
                </div>

                <p className="text-muted-foreground text-lg max-w-md mx-auto leading-relaxed">
                    We&apos;re currently blending the perfect checkout experience for you.
                    Soon you&apos;ll be able to grab your favorite juices with just a few clicks!
                </p>
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
                <Link href="/">
                    <Button variant="outline" className="rounded-full px-8 h-12 border-primary/20 hover:bg-primary/5 transition-all group">
