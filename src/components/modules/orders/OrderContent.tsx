            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground">
                        Order Tracking <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-500">is on its way!</span>
                    </h1>
                </div>

                <p className="text-muted-foreground text-lg max-w-md mx-auto leading-relaxed">
                    We&apos;re preparing something special to help you track your healthy goodness.
                    Your order history and live tracking will be available very soon!
                </p>
            </div>
