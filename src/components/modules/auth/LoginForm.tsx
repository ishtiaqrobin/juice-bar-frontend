...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 grid gap-4">
      ...
      <Button
        type="submit"
        className="bg-primary h-10 text-white hover:cursor-pointer relative gap-2"
      ...
      >
        ...
        {!isSubmitting && lastLogin === "email" && (
          <Badge
            variant="secondary"
            className="absolute -top-2 -right-2 text-[10px] h-4 bg-orange-100 text-orange-600 border-none"
          >
            Last used
          </Badge>
        )}
