      ...
      <div className="max-w-xl w-full text-center space-y-8 relative z-10">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-foreground leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-primary">
                Is Almost Here!
              </span>
            </h1>
          </div>
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-md mx-auto leading-relaxed">
            Every sip counts! We&apos;re preparing a system where you can earn
            tokens and redeem them for your favorite blends. Stay with us!
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link href="/">
            <Button
              variant="outline"
              className="rounded-full px-8 h-12 border-primary/20 hover:bg-primary/5 group shadow-sm flex gap-4"
            >
        ...
        <div className="pt-8 flex flex-col items-center justify-center gap-3 text-indigo-600/50 font-medium text-xs">
          ...
          <div className="flex gap-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className={`h-1.5 rounded-full ${i <= 3 ? "w-6 bg-indigo-500/40" : "w-1.5 bg-indigo-500/10"}`}
              />
            ))}
          </div>
        </div>
