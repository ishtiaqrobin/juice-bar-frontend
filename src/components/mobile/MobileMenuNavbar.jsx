...
const MobileMenuNavbar = ({ className = "" }) => {
  ...
  const [showMobileFilterDropdown, setShowMobileFilterDropdown] = React.useState(false);
  ...
  React.useEffect(() => {
    const handleClickOutside = (event) => {
      if (showMobileFilterDropdown && !event.target.closest('.mobile-filter-dropdown-container')) {
        setShowMobileFilterDropdown(false);
      }
    };
            ...
            <div className="relative w-full h-[203px] bg-white overflow-hidden mobile-filter-dropdown-container">
              ...
              <div className="px-5">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <label htmlFor="mobileShowOnlyAvailable" className="text-base leading-6 font-medium text-black">
