...
const ForgotPassword = () => {
  ...
  const onSubmit = async (data: ForgotPasswordFormValues) => {
    setLoading(true);
    try {
      const res = await fetch(API_ENDPOINTS.AUTH.FORGET_PASSWORD, {
        method: "POST",
      ...
      router.push(
        `/reset-password?email=${encodeURIComponent(data.email)}&new=true`,
      );
    } catch {
      ...
      <div className="w-full md:max-w-xl mx-auto bg-gray- rounded-lg px-0 md:px-6 pb-16 my-0">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-stone-600">
            ...
            <br className="hidden md:block" /> a 6-digit OTP to reset your
            password.
          </p>
        </div>
