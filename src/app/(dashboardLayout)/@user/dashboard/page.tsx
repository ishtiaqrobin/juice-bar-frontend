...
const DashboardPage = () => {
  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-primary/10 via-background to-primary/5 p-8 border border-primary/10">
        <div className="relative z-10">
          ...
          <p className="mt-2 text-lg text-muted-foreground max-w-2xl">
            Fuel your body with nature&apos;s best. Ready for your daily dose of
            vitamins?
          </p>
        ...
        <Card className="border-primary/10 border p-4 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between pb-4">
            <div>
              ...
              <CardDescription>
                Your latest taste of Friends Juice Bar
              </CardDescription>
            </div>
            <Link
              href="/orders"
          ...
          <CardContent>
            <div className="space-y-5">
              <div className="flex items-center justify-between group cursor-pointer">
                ...
                <div className="text-sm font-bold bg-primary/5 px-2 py-1 rounded-md text-primary">
                  $8.99
                </div>
              </div>
              <div className="flex items-center justify-between group cursor-pointer">
